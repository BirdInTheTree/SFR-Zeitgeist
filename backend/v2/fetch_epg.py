...
Usage:
    python -m backend.v2.fetch_epg                  # today
    python -m backend.v2.fetch_epg 2026-04-01        # specific date
    python -m backend.v2.fetch_epg --range 7         # today + 6 days back
"""
...
VTT_CACHE_DIR = PROJECT_ROOT / "demo-data" / "v2" / "vtt_cache"
